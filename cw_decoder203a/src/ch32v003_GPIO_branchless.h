...
#define GPIOx_to_port_n_GPIO_port_B			0b01
...
#define GPIO_port_n_to_GPIOx_GPIO_port_B		GPIOB
...
#define GPIO_port_n_to_RCC_APB2Periph_GPIO_port_B	RCC_APB2Periph_GPIOB
